...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    GenerateSecondCoins(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "SecondCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "SecondCoin is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "SecondCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "SecondCoin is downloading blocks...");
