...
const string strMessageMagic = "SecondCoin Signed Message:\n";
...
bool CTransaction::CheckTransaction() const
{
    ...
    for (unsigned int i = 0; i < vout.size(); i++)
    {
        ...
        // SecondCoin: enforce minimum output amount for user transactions until 1 May 2014 04:00:00 GMT
...
int64 GetProofOfWorkReward(unsigned int nBits)
{
    ...
    // SecondCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, bool bCoinYearOnly)
{
    ...
    if(fTestNet || nTime > STAKE_SWITCH_TIME)
    {
        ...
        // SecondCoin: A reasonably continuous curve is used to avoid shock to market
...
static const int64 nTargetTimespan = 3 * 24 * 60 * 60;  // three days 
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SecondCoin
    bool fStrictPayToScriptHash = true; // Always active in SecondCoin
...
bool CBlock::AddToBlockIndex(unsigned int nFile, unsigned int nBlockPos)
{
    ...
    printf("New StakeModifierChecksum is 0x%09x \n", pindexNew->nStakeModifierChecksum);
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // SecondCoin: check proof-of-stake block signature
    ...
    else
    {
        ...
        if(!fTestNet && fCheckSig)
        {
            ...
            // SecondCoin: check proof-of-work block signature
...
// SecondCoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SecondCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	const char* pszTimestamp = "The SecondCoin is born"; // head line

        CTransaction txNew;
        txNew.nTime = EPOCH_TIME;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = EPOCH_TIME;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2346721 : 162201;
	...
	printf("min nBit: %08x\n", block.nBits);
        ...
        assert(block.hashMerkleRoot == uint256("0x9ba44ce188f1e8fbcfd2444385b7e71fd9775aa1298b4880e25d180939dfee0f"));
